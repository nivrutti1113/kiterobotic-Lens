...
export default function ScienceComingSoonPage() {
  return (
    <div className="min-h-[70vh] bg-slate-50 flex items-center justify-center p-6 text-slate-900">
      <div className="max-w-md w-full bg-white rounded-3xl border-2 border-slate-200 p-8 shadow-xl text-center space-y-6">
        <div className="w-16 h-16 rounded-2xl bg-emerald-100 text-emerald-600 mx-auto flex items-center justify-center font-bold shadow-sm">
        ...
        <div className="space-y-2">
          ...
          <h1 className="text-2xl font-black text-slate-900">Science Experiment Lab</h1>
        ...
        <p className="text-xs text-slate-500 leading-relaxed">
          Virtual physics and kinetic science experiments are scheduled for a future update pass. Check out <strong>Junior Blocks Studio</strong> for visual block coding!
        </p>
