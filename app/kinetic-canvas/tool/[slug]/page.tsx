...
export default function ToolChipComingSoonPage({ params }: { params: { slug: string } }) {
      ...
      <div className="max-w-md w-full bg-white rounded-3xl border-2 border-slate-200 p-8 shadow-xl text-center space-y-6">
        ...
        <div className="space-y-2">
          <span className="text-[11px] font-extrabold px-3 py-1 rounded-full bg-amber-100 text-amber-800 border border-amber-300">
            Tier 3 · Creative Tool
          </span>
          <h1 className="text-2xl font-black text-slate-900">{toolName} Tool</h1>
        ...
        <p className="text-xs text-slate-500 leading-relaxed">
          The <strong>{toolName}</strong> tool chip is honestly labeled as coming soon in this pass. Try out the <strong>Junior Blocks Studio</strong>!
        </p>
