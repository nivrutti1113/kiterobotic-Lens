...
export default function Design3DStudioPage() {
  return (
    <div className="min-h-screen bg-[#FAF3EC] text-slate-900 flex flex-col font-sans select-none">
      <header className="bg-[#FFFDF9] border-b-2 border-[#EEDCD0] px-6 py-3 flex items-center justify-between shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="font-black text-base text-slate-950 font-heading">3D CAD Modeling Studio</h1>
              <p className="text-[11px] font-bold text-slate-600">Robotics 3D Mesh Modeling & STL Exporter</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <div className="flex-1 p-4 flex flex-col overflow-hidden">
        <ThreeCanvas initialShape="pyramid" title="3D CAD Mesh Viewport" />
      </div>
    </div>
  );
}
